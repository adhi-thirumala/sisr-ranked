/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d5d04f25613b059447f76a9325e55112)
...
interface __BaseEnv_Env {
	...
	DB: D1Database;
	ASSETS: Fetcher;
	AGENT_BASE_URL: "https://agent.example.internal";
	OAUTH_REDIRECT_URI: "https://example.com/api/auth/microsoft/callback";
	QUEUE: DurableObjectNamespace<import("./worker/index").Queue>;
	MATCH: DurableObjectNamespace<import("./worker/index").Match>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "Queue" | "Match";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AGENT_BASE_URL" | "OAUTH_REDIRECT_URI">> {}
}
